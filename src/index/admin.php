    ...
    function mostrarDatosTabla($tabla) {
        ...
        if (!$singleRow) {
            ...
            foreach ($select as $row) {
                ...
                echo "<td><button class='edit actions' type='button' id='" . $tipo . "editar_" . $row[$id] . "' class='edit'>" .
            ...
            echo "<tr>";
            echo "<td><button class='edit actions' type='button' id='" . $tipo . "editar_" . $select[$id] . "'>" .
                "<img src='../img/guardar.png'/>" . "<pre>Editar...</pre>" .
                "</button>";
